package io.alauda.project.controller;

import com.google.common.collect.Lists;
import io.alauda.microservice.vo.JwtUserInfo;
import io.alauda.project.domain.Project;
import io.alauda.project.repository.ProjectRepository;
import io.alauda.project.service.TodoService;
import io.alauda.project.service.UserService;
import io.alauda.project.stream.LoggerEventSink;
import io.alauda.project.vo.Card;
import io.alauda.project.vo.Message;
...
//    LoggerEventSink loggerEventSink;
    ...
    public Project create(@RequestBody Project project) throws Exception {
        ...
        todoService.batchCreateCard(cardList);
    ...
    public ResponseEntity list(){
        ...
        Long ids[] = userService.getUserProjects(jwtUserInfo.getUserId());
